...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("STUDANT", "INSTRUCTOR", "ADMIN", name="userrole"),
            server_default="STUDANT",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("WAITING", "RUNNING", "FINISHED", name="termstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("WAITING", "RUNNING", "FINISHED", "LATE", name="lessonstatus"),
